    ...
    <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul className="nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <a className="nav-link active" aria-current="page" href="#"> <div id="accordion">
            <div className="items">
              ...
              >
                <div className="right_content_product">
                  ...
                  <label> Dresses</label>
                  <span className="right_content_slide0">0</span>
                  <br />
                  ...
                  <label> Bags</label>
                  <span className="right_content_slide2">0</span>
                  <br />

                  <input type="checkbox" id="Jackets" />
                  <label> Jackets</label>
                  <span className="right_content_slide3">0</span>
                  <br />

                  <input type="checkbox" id="Shoes" />
                  <label> Shoes</label>
                  <span className="right_content_slide4">0</span>
                  <br />

                  <input type="checkbox" id="Jumpers" />
                  <label> Jumpers</label>
                  <span className="right_content_slide5">0</span>
                  <br />

                  <input type="checkbox" id="Jeans" />
                  <label> Jeans</label>
                  <span className="right_content_slide6">0</span>
                  <br />
...
<hr/></a>
        ...
        <li className="nav-item">
          <a className="nav-link" href="#"><div id="accordion">
...
<hr/></a>
 ...
 <hr className="right_content_line"/></a>
        </li>

        <li className="nav-item">
          <a className="nav-link" href="#"><div id="accordion">
            <div className="right_content_items">
              <div className="right_content_heading5">
