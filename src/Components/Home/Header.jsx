            ...
            <div className="header__upper">
                ...
                <div>
                    ...
                    <a href="tel:#">
                      ...
                      <div className="phone_Number header__upperLeft"> 
              ...
              {/* <Navbar bg="light" expand="lg">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                  <Nav className="mr-auto">
                    <NavDropdown title="Browse Categories" cssClass='e-caret-hide' id="basic-nav-dropdown">
                      ...
                      <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                          <ul class="navbar-nav header__bottomHover me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                              <a class="btn text-white" aria-current="page" href="/product">Product</a>
                            </li>
                            <li class="nav-item">
                              <a class="btn text-white" aria-current="page" href="/cart">Cart</a>
                            </li>
                            <li class="nav-item">
                              <a class="btn text-white" aria-current="page" href="/category">Category</a>
                            </li>
